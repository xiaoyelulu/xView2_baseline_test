...
if __name__ == '__main__':
    ...
    parser.add_argument('--input',
                        required=False,
                        default="/mnt/disk3/zwy/zwy/sematicseg/xView2_baseline-master/model/infer_data/out_pred/santa-rosa-wildfire_00000007_post_disaster.json",
                        metavar='/path/to/final/inference.json',
                        help="Full path to the final inference json")
    parser.add_argument('--output',
                        required=False,
                        default="/mnt/disk3/zwy/zwy/sematicseg/xView2_baseline-master/model/infer_data/out_pred/1.png",
